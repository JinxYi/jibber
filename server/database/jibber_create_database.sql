...
CREATE TABLE chatSession (
	...
	userOneId INT DEFAULT NULL,
	userTwoId INT DEFAULT NULL,
	isPrivate BOOLEAN,
	PRIMARY KEY (id),
	UNIQUE (id),
	FOREIGN KEY (userOneId) REFERENCES user (id) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (userTwoId) REFERENCES user (id) ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT UNQ_CHAT UNIQUE (userOneId, userTwoId)
);
